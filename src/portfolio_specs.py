EVAL_PORTFOLIO_SPECS = {
    "value_weighted_monthly_k10_tc3": {
        "portfolio_size": 10,
        "turnover_cost_bps": 3,
    ...
    "value_weighted_monthly_k20_tc3": {
        "portfolio_size": 20,
        "turnover_cost_bps": 3,
        "rebalancing_frequency": "monthly",
        "weights_spec": "value_weighted",
    ...
    "equally_weighted_monthly_k10_tc3": {
        "portfolio_size": 10,
        "turnover_cost_bps": 3,
        "rebalancing_frequency": "monthly",
    ...
    "equally_weighted_monthly_k20_tc3": {
        "portfolio_size": 20,
        "turnover_cost_bps": 3,
        "rebalancing_frequency": "monthly",
        "weights_spec": "equally_weighted",
    ...
    "log_normal_monthly_k10_tc3_scale1": {
        "portfolio_size": 10,
        "turnover_cost_bps": 3,
        "rebalancing_frequency": "monthly",
    ...
    "log_normal_monthly_k20_tc3_scale1": {
        "portfolio_size": 20,
        "turnover_cost_bps": 3,
        "rebalancing_frequency": "monthly",
        "weights_spec": "log_normal",
    ...
    "log_normal_monthly_k10_tc3_scale2": {
        "portfolio_size": 10,
        "turnover_cost_bps": 3,
        "rebalancing_frequency": "monthly",
        "weights_spec": "log_normal",
    ...
    "log_normal_monthly_k20_tc3_scale2": {
        "portfolio_size": 20,
        "turnover_cost_bps": 3,
        "rebalancing_frequency": "monthly",
        "weights_spec": "log_normal",
    ...
    "black_litterman_monthly_k10_tc3": {
        "portfolio_size": 10,
        "turnover_cost_bps": 3,
        "rebalancing_frequency": "monthly",
    ...
    "black_litterman_monthly_k20_tc3": {
        "portfolio_size": 20,
        "turnover_cost_bps": 3,
        "rebalancing_frequency": "monthly",
        "weights_spec": "black_litterman",
